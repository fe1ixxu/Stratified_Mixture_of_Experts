...
class TransformerDecoderBaseED(FairseqIncrementalDecoder):
    """
    ...
    def build_decoder_layer(self, cfg, no_encoder_attn=False, is_moe_layer=False):
        layer = TransformerDecoderLayerED(cfg, no_encoder_attn, is_moe_layer=is_moe_layer)
    ...
    def extract_features_scriptable(
        ...
        loss_keys = ["moe_gate_loss", "cmr_gate_loss_num", "cmr_gate_loss_denom", "ed_loss"]
...
class TransformerDecoderED(TransformerDecoderBaseED):
    def __init__(
        self,
        args,
        dictionary,
