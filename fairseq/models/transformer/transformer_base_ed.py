...
from fairseq.models.transformer import (
    TransformerConfig,
    TransformerDecoderBaseED,
    TransformerEncoderBaseED,
)

logger = logging.getLogger(__name__)


class TransformerModelBaseED(FairseqEncoderDecoderModel):
    """
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument('--hmoe-layer', type=int, help="Enable HMOE and indicate number of hmoe layers")
        parser.add_argument('--only-compute-current-layer-tokens', action='store_true', help="Only compute the current hmoe layer tokens to reduce the capacity and speed up training")
    ...
    def build_encoder(cls, cfg, src_dict, embed_tokens):
        return TransformerEncoderBaseED(cfg, src_dict, embed_tokens)

    @classmethod
    def build_decoder(cls, cfg, tgt_dict, embed_tokens):
        return TransformerDecoderBaseED(
            cfg,
            tgt_dict,
            embed_tokens,
