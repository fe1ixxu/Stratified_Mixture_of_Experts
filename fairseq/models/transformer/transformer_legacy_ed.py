...
from fairseq.models.transformer.transformer_base_ed import (
    TransformerModelBaseED,
)


@register_model("transformer_ed")
class TransformerModelED(TransformerModelBaseED):
    """
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument('--hmoe-layer', type=int, default=1, help="Enable HMOE and indicate number of hmoe layers")
        parser.add_argument('--only-compute-current-layer-tokens', type=int, default=0, help="Only compute the current hmoe layer tokens to reduce the capacity and speed up training")
        parser.add_argument('--hmoe-layernorm', type=int, default=0, help="Enable layernorm after each hmoe layer")
        parser.add_argument('--hmoe-dynamic', type=str, default=None, help="Decide the number of experts in each layer")
